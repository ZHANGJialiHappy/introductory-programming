public class Plant {
    private String name;
    private int moistureLevel, optimalMoistureLevel, optimalLightingLevel;
    ...
    public void printReport() {
        System.out.println(String.format("plantName: %s, current water: %d, required water: %d, required light: %d",
                name, moistureLevel, optimalMoistureLevel, optimalLightingLevel));
    }
